...
#define SX_RESET IO_PA8
#define SX_DIO1 IO_PA11
#define SX_BUSY IO_PA12
#define SX_RX_EN IO_PA0
#define SX_TX_EN IO_PA1
...
#define SX2_RESET IO_PB3
#define SX2_DIO1 IO_PB8
#define SX2_BUSY IO_PB9
#define SX2_RX_EN IO_PB4
#define SX2_TX_EN IO_PB5

#define SX2_DIO1_GPIO_AF_EXTI_PORTx LL_GPIO_AF_EXTI_PORTB
...
#define FIVEWAY_ADC_IO IO_PB0 // ADC_IN1
...
#define BUZZER_TIMx TIM3
#define BUZZER_IRQn TIM3_IRQn
#define BUZZER_IRQHandler TIM3_IRQHandler
